            ...
            child: DataTable2(
              ...
              rows: List<DataRow>.generate(
                7,
                    (index) => DataRow(
                  cells: [
                     const DataCell(CustomText(text: "Mahdi Mohammadi", size: 16, color: Colors.black, weight: FontWeight.bold,)),
                    const DataCell(CustomText(text: "Tehran", size: 16, color: Colors.black, weight: FontWeight.bold,)),
                    const DataCell(
                      Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          ...
                          SizedBox(width: 5),
                          CustomText(text: "4.5", size: 16, color: Colors.black, weight: FontWeight.bold,),
                        ],
                      ),
                    ),
                    DataCell(
